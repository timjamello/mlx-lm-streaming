...
class StreamingAttention(nn.Module):
    """
    Streaming variant of Qwen3 Attention that supports separate position encodings
...
class Qwen3ModelStreaming(nn.Module):
    """
    Streaming variant of Qwen3Model that supports dual cache and streaming generation.
    """
...
class Model(nn.Module):
    """
    Top-level streaming Qwen3 model with language modeling head.
    """
    ...
    def __init__(self, args: ModelArgs):
        ...
        self.model = Qwen3ModelStreaming(args)
